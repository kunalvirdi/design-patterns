...
public class SmartSecurityCameras extends SmartDeviceFactory {
    private static HashMap<String, SmartSecurityCamera> securityCameraHashMap=new HashMap<>();
    ...
    static {
        ...
        securityCameraHashMap.put(CameraModel.GUARDBASIC.name(),guardBasic);
        ...
        securityCameraHashMap.put(CameraModel.GUARDELITE.name(), guardElite);
        ...
        securityCameraHashMap.put(CameraModel.GUARDPRO.name(), guardPro);
    }

    @Override
    public SmartDevice getSmartDeviceModel(String model) {
        return (SmartDevice) securityCameraHashMap.get(model);
    }
}
